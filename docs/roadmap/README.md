...
6. `memory-gdsp-territory/TODO.md` — fix memory ownership, structural-plasticity territory timing, stale observations, territory availability, and engram resume integrity.
